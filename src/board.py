...
class Board:
    def __init__(self, board_width, board_height, board_offset, board_render_width, board_render_height):
        ...
        # Starting pieces
        self.board[int(self.board_width / 2)][int(self.board_height / 2)] = Cells.black
        self.board[int(self.board_width / 2) - 1][int(self.board_height / 2)] = Cells.white
        self.board[int(self.board_width / 2)][int(self.board_height / 2) - 1] = Cells.white
        self.board[int(self.board_width / 2) - 1][int(self.board_height / 2) - 1] = Cells.black
    ...
    def render_board(self, screen, board_position):
